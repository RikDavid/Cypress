describe ('Cadastrode usuarios', () => {
    ...
    usuarios.forEach(usuario => {
        it(`Verifica registro de novo usuário ${usuario.userName}`, () => {
            cy.registra(usuario.email, usuario.fullName, usuario.userName, usuario.senha);
        })
    })
})